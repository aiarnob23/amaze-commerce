...
export default function CompletePage() {
  ...
  return (
    <div className="container mx-auto flex flex-col justify-start my-44 gap-3 items-start ml-[40%] min-h-screen w-full " id="payment-status">
      <div className="p-2"
        id="status-icon"
      ...
      <h2 className="text-green-500 text-xl font-semibold" id="status-text">{STATUS_CONTENT_MAP[status].text}</h2>
      {intentId && (
      ...
      {intentId && (
        <a className="link text-blue-400 text-xl"
      ...
      <div>
        <a href="/main" className="text-green-400 link text-3xl font-semibold">Go Home</a>
      </div>
